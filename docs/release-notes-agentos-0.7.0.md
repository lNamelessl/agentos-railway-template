# AgentOS 0.7.0 Release Notes

AgentOS 0.7.0 is a release cut for the next published package and GitHub release cycle.

## Highlights

- Bumps the published npm package version to `0.7.0`.
