# AgentOS 0.6.10 Release Notes

AgentOS 0.6.10 is a patch release that refreshes the published package version and confirms the packaged CLI still ships cleanly.
